package com.webshop.users.error.handler;

import com.webshop.users.error.model.ApiError;
...
public class RestResponseErrorHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleAccessDeniedError(Exception ex) {
        ApiError apiError = new ApiError(HttpStatus.FORBIDDEN, "Access to API denied!");
        return buildResponseEntity(apiError);
    }
